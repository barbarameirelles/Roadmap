...
export const MONTH_DELIVERIES: MonthDelivery[] = [
  // ── Agosto/2026 ──────────────────────────────────────────────────────────────
  {
    ...
    groups: [
      {
        feature: "Evoluções",
        description: "XP + Audience\n• Segmentos pré-definidos no segmentador\n• Atributos personalizados (tela de cadastro, segmentador e subida de lista)\n• Campos de localidade (cidade e estado) no segmentador\n• Exclusão manual de cliente\n• Início da migração do sistema de disparo de e-mail\n\nApenas XP\n• Landing Pages (redirect pós-cadastro, modal de agradecimento e mudança de URL)\n• Ajustes na ordenação da visão de cliente\n• Nova tela de SDK\n• Modais on-site (por audiência/segmento e de agradecimento)\n• Importação de HTML para e-mail\n• Template de produto para e-mail (BTG)",
      ...
      },
      {
        ...
        issues: [
          ...
          { key: "FRONT-389", title: "Landing Page e On Site - Modal de agradecimento", status: "Done" },
          ...
          { key: "FRONT-760", title: "Inclusão do Clarity na plataforma 2.0", status: "Done" },
          { key: "FRONT-768", title: "Excluir Visao de cliente", status: "Done" },
          { key: "FRONT-769", title: "Erro ao pausar segmentação", status: "Done" },
          { key: "FRONT-776", title: "Atualizar SDK", status: "Done" },
          ...
          { key: "FRONT-851", title: "Pente Fino: Landing Pages e On-Site Pop-up", status: "Blocked", blocked: true },
          ...
          { key: "FRONT-857", title: "Pente Fino: Início (Home) e Evolução de Contatos", status: "In Progress" },
          { key: "FRONT-872", title: "Tirar dados Mocados Segmentos pré definidos", status: "Done" },
          { key: "FRONT-873", title: "Pente Fino: Segmentador", status: "In Progress" },
          ...
          { key: "POS-4450",  title: "Ajustes Lista", status: "Done" },
          { key: "POS-4468",  title: "Erro ao submeter formulário LP", status: "Done" },
          { key: "FRONT-908", title: "BUG - Mapeamento incorreto dos campos \"Nome\" e \"Telefone\" na importação de lista", status: "Done" },
          ...
          { key: "POS-4472",  title: "Padronizar endpoints de Segmentos Pré-definidos", status: "In Progress" },

...
export const FEATURES: Feature[] = [
  ...
  // ─── CDP – Enriquecimento ────────────────────────────────────────────────
  {
    ...
    storyPoints: 0,
    subtasks: [
      { key: "POS-4249", title: "Importação dos pedidos históricos dos clientes beta", status: "In Progress", points: 0 },
      { key: "POS-4345", title: "Automação de entrada de pedidos históricos (novo cliente Audience → histórico + vendas novas entram na CDP)", status: "In Progress", points: 0, sprint: 47 },
...

  {
    ...
    subtasks: [
      ...
      { key: "FRONT-850", title: "Pente Fino: Envios Pontuais e Automáticos", status: "To Do", points: 0, sprint: 47 },
      ...
      { key: "FRONT-855", title: "Pente Fino: Studio", status: "In Progress", points: 0, sprint: 47 },
...

  {
    ...
    storyPoints: 0,
    subtasks: [
      { key: "FRONT-871", title: "[UX] Configuração de Domínio e Remetentes de E-mail", status: "In Progress", points: 0, sprint: 47 },

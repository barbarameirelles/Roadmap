...
export const FEATURES: Feature[] = [
  ...
  // ─── CDP – Enriquecimento ────────────────────────────────────────────────
  {
    ...
    storyPoints: 0,
    subtasks: [
      { key: "POS-4249", title: "Importação dos pedidos históricos dos clientes beta", status: "To Do", points: 0, blocked: true },
      { key: "POS-4345", title: "Automação de entrada de pedidos históricos (novo cliente Audience → histórico + vendas novas entram na CDP)", status: "To Do", points: 0, sprint: 47, blocked: true },
...

  {
    ...
    subtasks: [
      ...
      { key: "POS-4450", title: "Erro ao subir lista", status: "Done", points: 0 },
  ...
  // ─── Evoluções ───────────────────────────────────────────────────────────
  {
    ...
    planned: { start: 12, end: 14 }, executed: null,
    status: "em-andamento", progress: 81,

...
export const FEATURES: Feature[] = [
  ...
  // ─── CDP ────────────────────────────────────────────────────────────────────
  {
    ...
    subtasks: [
      ...
      { key: "POS-4098", title: "[CDP] Unificação dos SDK: Usar API para a ingestão de dados", status: "In Progress", points: 5, sprint: 41 },
...

  {
    ...
    subtasks: [
      ...
      { key: "POS-3261",  title: "Permitir que qualquer campo de lista vire atributo do cliente", status: "In Progress", points: 5, sprint: 42 },
...

  {
    ...
    subtasks: [
      ...
      { key: "POS-3973",  title: "Implementação do Sistema de Notificação de Downloads", status: "In Progress", points: 0, sprint: 39 },

...
export const CURRENT_SPRINT = 45;
...
export const FEATURES: Feature[] = [
  ...
  // ─── CDP – Enriquecimento ────────────────────────────────────────────────
  {
    ...
    storyPoints: 0,
    subtasks: [
      { key: "POS-4249", title: "Ingerir dados de commerce por webhook", status: "In Progress", points: 0 },
...

  {
    ...
    status: "em-andamento", progress: 84,
    ...
    subtasks: [
      ...
      { key: "POS-4345", title: "TO DOS Para Liberação: Organizar importação", status: "In Progress", points: 0, sprint: 45 },
      ...
      { key: "POS-4382", title: "PRIORITÁRIO: Está faltando campo de origem do lead", status: "To Do", points: 0, sprint: 45 },
...

  {
    ...
    status: "em-andamento", progress: 50,
    note: "POS-3928 (deploy dos dados de receita) bloqueada no Jira.",
    owner: { name: "Pedro Dib", initials: "PD", color: "#0891b2" },
    storyPoints: 0,
    subtasks: [
...

  {
    ...
    storyPoints: 8,
    subtasks: [
      { key: "FRONT-683", title: "Segmentos Salvos em Campanhas Automáticas", status: "In Progress", points: 0, sprint: 43 },
      { key: "FRONT-684", title: "Audiências Pré-definidas em Campanhas Automáticas", status: "Done", points: 0, sprint: 43 },
      { key: "FRONT-685", title: "Listas em Campanhas Automáticas", status: "In Progress", points: 0, sprint: 43 },
  ...
  // ─── Evoluções ───────────────────────────────────────────────────────────
  {
    ...
    note: "FRONT-764 e FRONT-774 bloqueadas no Jira.",
    owner: { name: "isabela.beatriz", initials: "IB", color: "#7c3aed" },
    storyPoints: 0,
    subtasks: [
      ...
      { key: "FRONT-764", title: "[UX] Visão do cliente: Tela de pedidos e sessões", status: "To Do", points: 0, sprint: 43 },

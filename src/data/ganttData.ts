...
export const FEATURES: Feature[] = [
  ...
  // ── BTG frente 1: Motor de recomendação ──────────────────────────────────
  {
    ...
    status: "replanejado", progress: 85,
...

  {
    ...
    storyPoints: 0,
    subtasks: [
      { key: "POS-3928",  title: "Dados de receita - Fazer deploy e testes", status: "In Progress", points: 0, sprint: 39 },
  ...
  // ─── Evoluções ───────────────────────────────────────────────────────────
  {
    ...
    subtasks: [
      ...
      { key: "FRONT-771", title: "[UX] Visão do cliente: Ajustes de UI", status: "In Progress", points: 0, sprint: 44 },
    ],
  },

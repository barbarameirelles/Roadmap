...
export const FEATURES: Feature[] = [
  ...
  // ─── CDP ────────────────────────────────────────────────────────────────────
  {
    ...
    subtasks: [
      ...
      { key: "POS-4106", title: "[CDP] Liberar segmentos customizados para o commerce", status: "Done", points: 8, sprint: 41 },
      ...
      { key: "POS-4402", title: "Provisionamento nova conta de cliente", status: "In Progress", points: 0, sprint: 46 },
  ...
  // ── BTG frente 1: Motor de recomendação ──────────────────────────────────
  {
    ...
    status: "replanejado", progress: 83,
  ...
  // ─── CDP – Enriquecimento ────────────────────────────────────────────────
  {
    ...
    status: "em-andamento", progress: 69,
    owner: { name: "Pedro Dib", initials: "PD", color: "#0891b2" },
    storyPoints: 0,
    subtasks: [
      { key: "POS-4249", title: "Ingerir dados de commerce por webhook", status: "Done", points: 0 },
      ...
      { key: "FRONT-806", title: "Alterar label de compra finalizada em eventos (visão do cliente)", status: "In Progress", points: 0 },
      { key: "FRONT-807", title: "Visão de Clientes - Corrigir Visualização", status: "In Progress", points: 0 },
...

  {
    ...
    subtasks: [
      ...
      { key: "POS-4345", title: "TO DOS Para Liberação: Organizar importação", status: "Done", points: 0, sprint: 45 },
      ...
      { key: "POS-4352", title: "TO DOS Para Liberação: Visualizar lista arquivada", status: "In Progress", points: 0, sprint: 45 },
      { key: "POS-4379", title: "PRIORITÁRIO: Divergência número da base", status: "Done", points: 0, sprint: 45 },
      { key: "POS-4380", title: "PRIORITÁRIA: Landing page não abre", status: "In Progress", points: 0, sprint: 45 },
      { key: "POS-4381", title: "PRIORITÁRIA: Ordenação quebrando", status: "Done", points: 0, sprint: 45 },
      { key: "POS-4382", title: "PRIORITÁRIO: Está faltando campo de origem do lead", status: "In Progress", points: 0, sprint: 45 },
      ...
      { key: "POS-4398", title: "Redefinir quais status serão utilizados na LTV", status: "To Do", points: 0, sprint: 46 },
    ],
  },
  ...
  // ─── Q3 2026 ──────────────────────────────────────────────────────────────
  {
    ...
    status: "em-andamento", progress: 34,
    ...
    subtasks: [
      ...
      { key: "POS-4424",  title: "Cadastrar novas regras dentro do Unomi", status: "In Progress", points: 0, sprint: 46 },
      ...
      { key: "FRONT-830", title: "Ajustes para lançamento de campanhas", status: "To Do", points: 0, sprint: 46 },
      ...
      { key: "POS-4421",  title: "Erro de envio de teste", status: "To Do", points: 0, sprint: 46 },
      { key: "POS-4422",  title: "Corrigir validação de campanhas automáticas para audiências do tipo Segmento", status: "To Do", points: 0, sprint: 46 },
    ],
  },

  {
    ...
    storyPoints: 0,
    subtasks: [
      { key: "FRONT-729", title: "[UX] Feature de SMS", status: "In Progress", points: 0 },
    ],
  },
...

  {
    ...
    subtasks: [
      ...
      { key: "FRONT-310", title: "Exportação de Relatórios CSV: Envios Pontuais", status: "In Progress", points: 0, sprint: 38 },
      ...
      { key: "FRONT-407", title: "Exportação de Relatórios CSV: Envios Automáticos", status: "In Progress", points: 0, sprint: 42 },
      { key: "FRONT-419", title: "Exportação de Relatórios CSV: Segmentos", status: "In Progress", points: 0, sprint: 43 },
      ...
      { key: "FRONT-448", title: "Colocar receita e exportar CSV nas campanhas", status: "In Progress", points: 0, sprint: 42 },
...

  {
    ...
    subtasks: [
      ...
      { key: "FRONT-684", title: "Audiências Pré-definidas em Campanhas Automáticas", status: "In Progress", points: 0, sprint: 43 },
  ...
  // ─── Evoluções ───────────────────────────────────────────────────────────
  {
    ...
    subtasks: [
      ...
      { key: "FRONT-770", title: "Incluir campo de UF no segmentador", status: "Done", points: 0 },
      { key: "FRONT-772", title: "Incluir campos de compra no segmentador", status: "To Do", points: 0 },
      { key: "FRONT-774", title: "Front Segmentador: Interesse e navegação", status: "In Progress", points: 0 },

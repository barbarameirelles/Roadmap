...
export const FEATURES: Feature[] = [
...

  {
    ...
    subtasks: [
      ...
      { key: "POS-4106", title: "[CDP] Liberar segmentos customizados para o commerce", status: "In Progress", points: 8 },
      { key: "POS-4109", title: "Estruturação de Consumo - Catálogo de produtos Commerce", status: "To Do", points: 0 },
      { key: "POS-4115", title: "[CDP] Unificação dos SDKs: Unificar SDK de plug-ins dentro da SDK nova criada", status: "In Progress", points: 0 },
      { key: "POS-4116", title: "Obter profile por ID", status: "Done", points: 3 },
  ...
  // ── BTG frente 1: Motor de recomendação ──────────────────────────────────
  {
    ...
    subtasks: [
      ...
      { key: "POS-3773", title: "Criação da estruturação de eventos", status: "Done", points: 0 },
      ...
      { key: "POS-3832", title: "Criação do Worker de Inserção de Eventos na CDP", status: "Done", points: 0 },
  ...
  // ── BTG frente 2: Primeiro grupo de regras (prontas ou em andamento) ──────
  {
    ...
    subtasks: [
      ...
      { key: "FRONT-220", title: "BTG - Regra de Inativos", status: "In Progress", points: 0 },
      { key: "FRONT-537", title: "BTG - Regra Reconquista", status: "In Progress", points: 0 },
      { key: "FRONT-542", title: "BTG - Regra de Indecisos", status: "In Progress", points: 0 },
...

  {
    ...
    subtasks: [
      ...
      { key: "FRONT-674", title: "Relatório de Opt-out", status: "To Do", points: 0 },
    ],
  },
...

  {
    ...
    subtasks: [
      ...
      { key: "FRONT-216", title: "Implementar aba Compras na visão do cliente", status: "Done", points: 0 },

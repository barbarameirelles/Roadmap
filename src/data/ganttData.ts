...
export const FEATURES: Feature[] = [
  ...
  // ─── CDP ────────────────────────────────────────────────────────────────────
  {
    ...
    subtasks: [
      ...
      { key: "POS-4109", title: "Estruturação de Consumo - Catálogo de produtos Commerce", status: "In Progress", points: 0, sprint: 42 },
...

  {
    ...
    status: "em-andamento", progress: 35,
    owner: { name: "Pedro Dib", initials: "PD", color: "#0891b2" },
    storyPoints: 0,
    subtasks: [
      { key: "POS-3928",  title: "Dados de receita - Fazer deploy e testes", status: "To Do", points: 0, sprint: 39 },
      { key: "POS-3929",  title: "Dados de receita - Gerar arquivo de download", status: "In Progress", points: 0, sprint: 39 },
  ...
  // ─── Evoluções ───────────────────────────────────────────────────────────
  {
    ...
    planned: { start: 12, end: 14 }, executed: null,
    status: "em-andamento", progress: 52,
    owner: { name: "isabela.beatriz", initials: "IB", color: "#7c3aed" },
    storyPoints: 0,
    subtasks: [
      ...
      { key: "FRONT-775", title: "Córtex: Conexão à API Real (Home + Segmentador)", status: "To Do", points: 0 },
      ...
      { key: "FRONT-769", title: "Erro ao pausar segmentação", status: "In Progress", points: 0, sprint: 44 },
      { key: "FRONT-764", title: "[UX] Visão do cliente: Tela de pedidos e sessões", status: "In Progress", points: 0, sprint: 43 },

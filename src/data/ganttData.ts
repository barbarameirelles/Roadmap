...
export const FEATURES: Feature[] = [
  ...
  // ─── CDP ────────────────────────────────────────────────────────────────────
  {
    ...
    subtasks: [
      ...
      { key: "POS-4129", title: "Consolidar dados de Campanhas", status: "In Progress", points: 0, sprint: 41, blocked: true },
  ...
  // ── BTG frente 1: Motor de recomendação ──────────────────────────────────
  {
    ...
    subtasks: [
      ...
      { key: "POS-3770",  title: "Construção das regras: Navegações e abandono de carrinho", status: "In Progress", points: 5, sprint: 37, blocked: true },
      ...
      { key: "POS-4063", title: "Consolidação Recorrência", status: "In Progress", points: 0, sprint: 42, blocked: true },
  ...
  // ─── CDP – Enriquecimento ────────────────────────────────────────────────
  {
    ...
    storyPoints: 0,
    subtasks: [
      { key: "POS-4249", title: "Importação dos pedidos históricos dos clientes beta", status: "In Progress", points: 0, blocked: true },
      { key: "POS-4345", title: "Automação de entrada de pedidos históricos (novo cliente Audience → histórico + vendas novas entram na CDP)", status: "In Progress", points: 0, sprint: 47, blocked: true },
      ...
      { key: "FRONT-770", title: "Incluir campo de UF no segmentador", status: "In Progress", points: 0, blocked: true },
      { key: "FRONT-774", title: "Front Segmentador: Interesse e navegação", status: "In Progress", points: 0, blocked: true },
      { key: "FRONT-779", title: "Segmentador: Canal / Loja: carregar lojas e site via API", status: "In Progress", points: 0, blocked: true },
...

  {
    ...
    subtasks: [
      ...
      { key: "FRONT-744", title: "Perfil do Cliente: Informações Pessoais, Visão Geral, Listas e Segmentos", status: "In Progress", points: 0, sprint: 46, blocked: true },
  ...
  // ─── Q3 2026 ──────────────────────────────────────────────────────────────
  {
    ...
    status: "em-andamento", progress: 59,
    ...
    subtasks: [
      ...
      { key: "FRONT-809", title: "IP Dedicado e Entregabilidade de E-mail", status: "In Progress", points: 0, sprint: 46, blocked: true },
...

  {
    ...
    subtasks: [
      ...
      { key: "FRONT-852", title: "Pente Fino: Gestão de Listas + Atributos Personalizados", status: "In Progress", points: 0, sprint: 47 },
...

  {
    ...
    subtasks: [
      ...
      { key: "FRONT-310", title: "Exportação de Relatórios CSV: Envios Pontuais", status: "In Progress", points: 0, sprint: 38, blocked: true },
      { key: "FRONT-370", title: "Disponibilizar CSV com dados das campanhas para download", status: "Done", points: 0 },
      { key: "FRONT-407", title: "Exportação de Relatórios CSV: Envios Automáticos", status: "In Progress", points: 0, sprint: 42, blocked: true },
      { key: "FRONT-419", title: "Exportação de Relatórios CSV: Segmentos", status: "In Progress", points: 0, sprint: 43, blocked: true },
      ...
      { key: "FRONT-448", title: "Colocar receita e exportar CSV nas campanhas", status: "In Progress", points: 0, sprint: 42, blocked: true },
...

  {
    ...
    storyPoints: 8,
    subtasks: [
      { key: "FRONT-683", title: "Segmentos Salvos em Campanhas Automáticas", status: "In Progress", points: 0, sprint: 43, blocked: true },
      { key: "FRONT-684", title: "Audiências Pré-definidas em Campanhas Automáticas", status: "Done", points: 0, sprint: 43 },
      { key: "FRONT-685", title: "Listas em Campanhas Automáticas", status: "In Progress", points: 0, sprint: 43, blocked: true },

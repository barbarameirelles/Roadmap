...
export const FEATURES: Feature[] = [
...

  {
    ...
    subtasks: [
      ...
      { key: "POS-4096", title: "[CDP] Ingerir o dado via API - Dados da SDK", status: "In Progress", points: 3, sprint: 41 },
  ...
  // ── BTG frente 2: Primeiro grupo de regras (prontas ou em andamento) ──────
  {
    ...
    tags: ["platform2", "cdp"],
    planned: { start: 3, end: 5 }, executed: { start: 3, end: 4 },
    status: "em-andamento", progress: 68,
    owner: { name: "Ricardo Barretto", initials: "RB", color: "#dc2626" },
    storyPoints: 14,
    subtasks: [
...

  {
    ...
    tags: ["platform2", "cdp"],
    planned: { start: 3, end: 5 }, executed: { start: 3, end: 4 },
    status: "em-andamento", progress: 71,
    owner: { name: "Renato Novaes", initials: "RN", color: "#059669" },
    storyPoints: 0,
    subtasks: [

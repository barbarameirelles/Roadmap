...
export const FEATURES: Feature[] = [
...

  {
    ...
    subtasks: [
      ...
      { key: "POS-2895",  title: "Criação de pipeline e DNS", status: "Done", points: 3 },
      { key: "POS-2897",  title: "Layout do menu e conteúdo", status: "Done", points: 3 },
      ...
      { key: "POS-3034",  title: "Criação de registros de Plataforma SMB", status: "Done", points: 0 },
      { key: "POS-3035",  title: "Testes de integração SMB", status: "Done", points: 0 },
      ...
      { key: "POS-3118",  title: "Configuração de ambiente de staging", status: "Done", points: 0 },
      { key: "POS-3200",  title: "Ajustes de UI", status: "Done", points: 2 },
      { key: "POS-3221",  title: "Tela inicial da plataforma", status: "Done", points: 3 },
      { key: "POS-3235",  title: "Ajustes de autenticação e permissões", status: "Done", points: 0, sprint: 32 },
      ...
      { key: "POS-3270",  title: "Configuração de variáveis de ambiente por tenant", status: "Done", points: 0, sprint: 33 },
...

  {
    ...
    storyPoints: 24,
    subtasks: [
      { key: "POS-4069", title: "Eventos de register não sendo emitidos no SDK", status: "To Do", points: 0 },
      { key: "POS-4096", title: "[CDP] Ingerir o dado via API - Dados da SDK", status: "To Do", points: 3, sprint: 41 },
      { key: "POS-4097", title: "[CDP] Unificação dos SDK: Juntar SDK On site + SDK SMB", status: "In Progress", points: 5, sprint: 41 },
      { key: "POS-4098", title: "[CDP] Unificação dos SDK: Usar API para a ingestão de dados", status: "To Do", points: 5, sprint: 41 },
      { key: "POS-4106", title: "[CDP] Liberar segmentos customizados para o commerce", status: "In Progress", points: 8, sprint: 41 },
      { key: "POS-4109", title: "Estruturação de Consumo - Catálogo de produtos Commerce", status: "To Do", points: 0, sprint: 42 },
      { key: "POS-4115", title: "[CDP] Unificação dos SDKs: Unificar SDK de plug-ins dentro da SDK nova criada", status: "In Progress", points: 0, sprint: 41 },
      ...
      { key: "POS-4131", title: "Consolidar Cidade e Estado", status: "To Do", points: 0, sprint: 41 },
      ...
      { key: "POS-4195", title: "[CDP] Alterar um endpoint específico para disponibilizar segmentos criados pelo cliente", status: "To Do", points: 0, sprint: 41 },
    ],
  },
  ...
  // ── BTG frente 2: Primeiro grupo de regras (prontas ou em andamento) ──────
  {
    ...
    subtasks: [
      ...
      { key: "POS-4059", title: "Consolidação Aniversário", status: "To Do", points: 3, sprint: 41 },
      { key: "FRONT-534", title: "BTG - Regra de Decididos", status: "In Progress", points: 0, sprint: 40 },
      { key: "FRONT-376", title: "BTG - Navegação Semanal", status: "In Progress", points: 0, sprint: 40 },
      { key: "FRONT-535", title: "BTG - Regra Navegação Mensal", status: "In Progress", points: 0, sprint: 40 },
      { key: "FRONT-548", title: "BTG - Regra de Navegação", status: "In Progress", points: 0, sprint: 40 },
      { key: "FRONT-150", title: "BTG - Abandono – Disparo e Conteúdo", status: "In Progress", points: 0, sprint: 39 },
      { key: "FRONT-153", title: "BTG - Pós-Compra – Disparo e Conteúdo", status: "In Progress", points: 0, sprint: 40 },
      { key: "FRONT-220", title: "BTG - Regra de Inativos", status: "In Progress", points: 0, sprint: 41 },
      { key: "FRONT-537", title: "BTG - Regra Reconquista", status: "In Progress", points: 0, sprint: 41 },
      { key: "FRONT-542", title: "BTG - Regra de Indecisos", status: "In Progress", points: 0, sprint: 41 },
      ...
      { key: "POS-3924",  title: "Segmentação de Indecisos", status: "To Do", points: 3, sprint: 41 },
      { key: "POS-4050",  title: "Segmentação dos Dados de Redução de Preços", status: "To Do", points: 3, sprint: 41 },
...

  {
    ...
    subtasks: [
      ...
      { key: "FRONT-267", title: "Segmentador: critérios de origem com janela de tempo", status: "In Progress", points: 0, sprint: 39 },
      { key: "FRONT-280", title: "Ajustes segmentador", status: "Done", points: 0, sprint: 37 },
      { key: "FRONT-391", title: "Segmentador: Campos Custom", status: "To Do", points: 0, sprint: 42 },
...

  {
    ...
    subtasks: [
      ...
      { key: "POS-3261",  title: "Permitir que qualquer campo de lista vire atributo do cliente", status: "To Do", points: 5, sprint: 42 },
      ...
      { key: "POS-3928",  title: "Dados de receita - Fazer deploy e testes", status: "To Do", points: 0, sprint: 39 },
      { key: "POS-3929",  title: "Dados de receita - Gerar arquivo de download", status: "To Do", points: 0, sprint: 39 },
      { key: "POS-4039",  title: "Criar tabela com dados de Receita das campanhas", status: "To Do", points: 0, sprint: 39 },
      { key: "POS-3973",  title: "Implementação do Sistema de Notificação de Downloads", status: "To Do", points: 0, sprint: 39 },
      ...
      { key: "FRONT-370", title: "Disponibilizar CSV com dados das campanhas para download", status: "To Do", points: 0 },
      { key: "FRONT-382", title: "Matriz RFV", status: "To Do", points: 0 },
      { key: "FRONT-383", title: "Mostrar alteração de volume de um segmento", status: "To Do", points: 0 },
      ...
      { key: "FRONT-438", title: "Home - card de Receita Total e coluna Receita em Performance", status: "To Do", points: 0, sprint: 42 },
...

  {
    ...
    tags: ["platform2"],
    planned: { start: 3, end: 11 }, executed: { start: 3, end: 4 },
  ...
  // ── BTG frente 3: Segundo grupo de regras (não iniciadas) ─────────────────
  {
    ...
    subtasks: [
      ...
      { key: "FRONT-536", title: "BTG - Regra Propensos a Comprar", status: "To Do", points: 3, sprint: 42 },
      { key: "FRONT-538", title: "BTG - Regra Recorrência", status: "To Do", points: 3, sprint: 42 },
      { key: "FRONT-539", title: "BTG - Regra Novos Cadastros", status: "To Do", points: 3, sprint: 42 },
      ...
      { key: "FRONT-543", title: "BTG - Regra Lista de Desejos", status: "To Do", points: 3, sprint: 42 },
      { key: "FRONT-546", title: "BTG - Regra Redução de Preços Similares", status: "To Do", points: 3, sprint: 42 },
      { key: "FRONT-547", title: "BTG - Regra de Tendências", status: "To Do", points: 3, sprint: 42 },
...

  {
    ...
    storyPoints: 3,
    subtasks: [
      { key: "FRONT-215", title: "Visão única do cliente: Origem do lead", status: "In Progress", points: 0, sprint: 38 },
      { key: "FRONT-216", title: "Implementar aba Compras na visão do cliente", status: "Done", points: 0, sprint: 38 },
      { key: "FRONT-217", title: "Visão única de Clientes: filtros multi-seleção, colunas Origem e LTV", status: "In Progress", points: 3, sprint: 39 },
      { key: "FRONT-390", title: "Visão única: Campos custom", status: "Done", points: 0, sprint: 39 },
      { key: "FRONT-585", title: "Visão Única de Clientes - Ajustar remoção de filtro", status: "In Progress", points: 0, sprint: 41 },
...

  {
    ...
    subtasks: [
      ...
      { key: "FRONT-154", title: "Importação de HTML para E-mail e Unificação da Biblioteca de Templates", status: "To Do", points: 0, sprint: 41 },
  ...
  // ─── CDP ──────────────────────────────────────────────────────────────────
  {
    ...
    storyPoints: 0,
    subtasks: [
      { key: "FRONT-225", title: "Setup de monitoramento e analytics", status: "In Progress", points: 0, sprint: 39 },
